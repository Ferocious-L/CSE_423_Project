...
class CarRacingGame:
    def __init__(self):
        ...
        self.move_speed = 7
        self.keys = {}
        self.grass_points = self.create_grass_points()
        self.side_lines = self.create_side_lines()
    ...
    def control_buttons(self):
        ...
        if self.paused:
            ...
            filled_rect(PAUSE_X - 10, BUTTON_Y + 5, PAUSE_X - 5, BUTTON_Y + 25)
            filled_rect(PAUSE_X + 5, BUTTON_Y + 5, PAUSE_X + 10, BUTTON_Y + 25)
    ...
    def display(self):
        ...
        if self.game_state == MENU:
            ...
            self.draw_text(SCREEN_WIDTH // 2 - 100, SCREEN_HEIGHT // 2,
